 ...
 var ctx = document.getElementById("broadcastchart");
...
var broadcastDataInput = document.getElementById("broadcastData");
var broadcastData = JSON.parse(broadcastDataInput.value);
    ...
    scales: {
      ...
      yAxes: [{
        ticks: {
          ...
          padding: 10,
          beginAtZero: true,
          suggestedMax: Math.max(...broadcastData), // Use the maximum value in the data as the suggested maximum for the y-axis
